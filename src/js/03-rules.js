...
const T = {
  OCT:      {ko:"황반 OCT", en:"Macular OCT", d_ko:"프리미엄 IOL 상담 전 필수. 미세한 황반질환이 대비감도 손실을 증폭시킵니다.", d_en:"Mandatory before premium IOL counselling; subtle maculopathy amplifies contrast loss."},
  TOPO:     {ko:"각막지형도 · 단층촬영 (Placido + Scheimpflug/OCT)", en:"Corneal topography and tomography", d_ko:"불규칙 난시, 후면각막난시, 확장증 선별.", d_en:"Screens irregular astigmatism, posterior astigmatism and ectasia."},
  ABERRO:   {ko:"각막 수차 분석 (HOA·coma·구면수차, 4 mm & 6 mm)", en:"Corneal aberrometry (HOA, coma, SA at 4 and 6 mm)", d_ko:"측정 동공경과 장비를 함께 기록하세요.", d_en:"Record the analysis zone and device."},
  PUPIL:    {ko:"명소시·암소시 동공 계측 (pupillometry)", en:"Photopic and mesopic pupillometry", d_ko:"야간 광학현상 위험 평가.", d_en:"Assesses night-time dysphotopsia risk."},
  KAPPA:    {ko:"Chord mu / chord alpha 측정", en:"Chord mu / chord alpha", d_ko:"단독 변수로 결론짓지 말고 장비명을 함께 기록.", d_en:"Never decide on this alone; record the device."},
  OSD:      {ko:"안구표면 평가 (눈물삼투압 · MMP-9 · SPEED II · LLPP 진찰)", en:"Ocular surface workup (osmolarity, MMP-9, SPEED II, LLPP)", d_ko:"ASCRS 알고리즘. 이상 시 치료 후 생체계측 재시행.", d_en:"ASCRS algorithm; re-do biometry after treatment if abnormal."},
  ENDO:     {ko:"각막내피세포 검사 (specular microscopy)", en:"Specular microscopy", d_ko:"구타타·푹스이상증 의심 시.", d_en:"When guttata or Fuchs dystrophy is suspected."},
  VF:       {ko:"시야검사 + 시신경 OCT (RNFL·GCC)", en:"Visual field and optic nerve OCT", d_ko:"녹내장 중증도 확정.", d_en:"Establishes glaucoma severity."},
  BIOM:     {ko:"광간섭 생체계측 (안축장·전방깊이·수정체두께)", en:"Optical biometry (AL, ACD, LT)", d_ko:"", d_en:""},
  POSTREF:  {ko:"굴절수술 전 기록 확보 + 굴절수술 후 IOL 계산식 (Barrett True-K, ASCRS 계산기)", en:"Pre-refractive-surgery records and post-LVC IOL formulas (Barrett True-K, ASCRS calculator)", d_ko:"", d_en:""},
  MACSTAB:  {ko:"망막 전문의 협진 — 질환 안정성 및 향후 치료 계획 확인", en:"Retina consultation — disease stability and future treatment plan", d_ko:"", d_en:""},
  CS:       {ko:"대비감도 검사 (선택)", en:"Contrast sensitivity testing (optional)", d_ko:"", d_en:""},
  DILAT:    {ko:"산동 반응 확인 및 IFIS 대비 계획", en:"Dilation response and IFIS plan", d_ko:"", d_en:""},
  TCA:      {ko:"총 각막난시(TCA) 측정 — 후면각막 포함", en:"Total corneal astigmatism including posterior surface", d_ko:"", d_en:""},
...
/* ============ HARD STOP ============ */
{
  ...
  targets:["enhMono","edofND","edofDiff","trifocal","smallAp","monoBlend"],
...
},
{
  ...
  targets:["edofDiff","trifocal","smallAp"],
  when:d => ["amd_advanced","dme","erm_significant","other"].includes(d.macula),
  ko:{t:"시력을 제한하는 황반질환", why:"회절형 광학은 빛을 여러 초점으로 나누어 대비감도를 낮춥니다. 이미 황반질환으로 대비감도가 떨어진 눈에서는 손실이 중첩되어 체감 시질이 크게 나빠집니다. 소구경 IOL은 망막 도달 광량을 더 줄이고 안저 관찰도 방해합니다.", act:"단초점 또는 프리미엄 단초점을 기본으로 하고, 비회절 EDOF는 망막 전문의와 질환 안정성을 확인한 뒤에만 개별 검토하세요."},
  en:{t:"Vision-limiting macular disease", why:"Diffractive optics split light across foci and lower contrast sensitivity. In an eye whose contrast is already reduced by maculopathy the losses compound. A small-aperture IOL further reduces retinal illumination and obscures the fundus view.", act:"Default to a monofocal or enhanced monofocal; consider non-diffractive EDOF only after retina review confirms stability."},
...
},
{
  ...
  ko:{t:"중등도 이상 녹내장", why:"녹내장은 시력보다 대비감도를 먼저 침범합니다. 회절형 렌즈의 대비감도 손실이 여기에 더해지면 실질적 시기능이 크게 떨어집니다. 소구경 IOL은 망막 도달 광량 감소로 시야검사 신뢰도와 야간 시력을 추가로 악화시킬 수 있습니다.", act:"단초점 또는 프리미엄 단초점. 중등도이면서 조절이 매우 양호하고 진행이 없는 경우에 한해 비회절 EDOF를 개별 검토할 수 있습니다."},
  en:{t:"Moderate or severe glaucoma", why:"Glaucoma degrades contrast sensitivity before acuity; adding the contrast loss of diffractive optics compounds the deficit. A small-aperture IOL further reduces retinal illumination, degrading both night vision and perimetry reliability.", act:"Monofocal or enhanced monofocal. Non-diffractive EDOF only case-by-case in well-controlled, non-progressing moderate disease."},
...
{
  id:"rk", layer:"stop",
  targets:["trifocal","edofDiff"], boost:{smallAp:1.5},
  when:d => d.priorRefSx === "rk",
  ko:{t:"방사상각막절개(RK) 과거력", why:"RK 각막은 하루 중에도 굴절력이 변동하고(diurnal shift) 다구역·불규칙 광학을 가집니다. 도수 예측 오차가 커서 회절형 렌즈의 초점 배치를 신뢰할 수 없습니다.", act:"단초점 또는 소구경 IOL을 검토하고, 잔여 굴절 이상 교정 계획(안경·추가 시술)을 미리 상의하세요."},
  en:{t:"Prior radial keratotomy", why:"An RK cornea shifts refraction through the day and is multizonal and irregular. Power prediction error is large, so the focal placement of a diffractive optic cannot be trusted.", act:"Consider a monofocal or a small-aperture IOL, and plan in advance for residual refractive error."},
  refs:["R9","R18"], grade:"C", tests:[T.TOPO, T.ABERRO, T.POSTREF]
},
{
  id:"zonule_unstable", layer:"stop",
  targets:["edofDiff","trifocal","edofND","smallAp","monoBlend"],
...
{
  id:"vitrectomy_smallap", layer:"stop",
  targets:["smallAp"],
  when:d => !!d.vitrectomy,
  ko:{t:"유리체절제술 과거력 또는 향후 필요 가능성", why:"소구경 IOL의 불투명 마스크는 주변부 안저 관찰과 유리체망막 수술 시야를 가립니다. 제조사 지침에서도 이런 경우를 배제합니다.", act:"소구경 IOL을 후보에서 제외하고 다른 방식으로 초점심도를 확보하세요."},
  en:{t:"Prior or anticipated vitreoretinal surgery", why:"The opaque mask of a small-aperture IOL obscures the peripheral fundus and the surgical view. Manufacturer guidance excludes these eyes.", act:"Remove the small-aperture option and obtain depth of focus another way."},
  refs:["R18"], grade:"D", tests:[]
},
{
  id:"expectation", layer:"stop",
  targets:["edofDiff","trifocal"],
...
/* ============ CAUTION ============ */
{
  ...
  targets:{trifocal:3, edofDiff:2.5, edofND:1, smallAp:2.5},
...
},
{
  ...
  targets:{trifocal:2, edofDiff:1.5, edofND:0.5, smallAp:2},
...
},
{
  ...
  targets:{trifocal:2.5, edofDiff:2, edofND:1, smallAp:2},
  when:d => d.dr === "npdr",
...
},
{
  ...
  targets:{trifocal:2.5, edofDiff:2, edofND:1, smallAp:1.5},
...
},
{
  ...
  targets:{trifocal:3, edofDiff:2.5, edofND:1.5}, boost:{smallAp:1},
  when:d => d.cornea === "kc_stable",
  ko:{t:"안정된 원추각막 · forme fruste", why:"안정적이어도 각막 고위수차가 정상보다 크고, 향후 진행 가능성이 완전히 사라진 것은 아닙니다. 도수 계산 오차도 큽니다.", act:"수차 수치를 직접 확인하고, 진행이 없음을 여러 시점의 지형도로 확인하세요. 소구경 IOL이 대안이 될 수 있습니다."},
  en:{t:"Stable keratoconus or forme fruste", why:"Even when stable, corneal higher-order aberrations exceed normal and progression is not fully excluded. Power calculation error is also larger.", act:"Measure the aberrations directly and confirm stability on serial topography. A small-aperture IOL may be an alternative."},
  refs:["R13","R18"], grade:"C", tests:[T.TOPO, T.ABERRO]
},
{
  id:"ebmd", layer:"caution",
  targets:{trifocal:2, edofDiff:1.5, edofND:1, enhMono:0.5, smallAp:1.5},
...
},
{
  ...
  targets:{trifocal:1.5, edofDiff:1.2, edofND:1, enhMono:0.5, smallAp:1},
  when:d => d.osd === "mild",
...
},
{
  ...
  targets:{trifocal:2.5, edofDiff:1.5, edofND:0.5},
...
},
{
  ...
  targets:{trifocal:2, edofDiff:1.5, smallAp:1.5},
...
},
{
  ...
  targets:{trifocal:1, edofDiff:0.7},
  when:d => {
...
},
{
  ...
  targets:{trifocal:2.5, edofDiff:2, edofND:1}, boost:{smallAp:1},
  when:d => {
...
},
{
  ...
  targets:{trifocal:2, edofDiff:1.5}, boost:{smallAp:1},
  when:d => num(d.cornealComa) !== null && d.cornealComa > 0.3,
  ko:{t:"각막 코마 > 0.3 µm @6 mm", why:"코마는 비대칭 수차로, 회절형 렌즈의 초점 분리와 겹치면 잔상·꼬리끌림 형태의 광학현상으로 나타나기 쉽습니다. 원추각막·편심 절제·이식 후 각막에서 흔합니다.", act:"원인(확장증·편심 절제·이식)을 먼저 규명하세요. 소구경 IOL이 코마의 영향을 줄이는 대안이 될 수 있습니다."},
  en:{t:"Corneal coma > 0.3 µm at 6 mm", why:"Coma is an asymmetric aberration; combined with the focal separation of a diffractive optic it tends to produce comet-tail smearing. It is common in keratoconus, decentred ablations and grafts.", act:"Identify the cause (ectasia, decentred ablation, graft) first. A small-aperture IOL can reduce the impact of coma."},
  refs:["R8","R18"], grade:"C", tests:[T.ABERRO, T.TOPO]
},
{
  id:"pupil_meso_large", layer:"caution",
  targets:{trifocal:2, edofDiff:1.5, edofND:0.5},
...
},
{
  ...
  targets:{trifocal:1.5, edofDiff:1.2, smallAp:2},
  when:d => num(d.pupPhotopic) !== null && d.pupPhotopic < 2.5,
  ko:{t:"명소시 동공 < 2.5 mm", why:"동공이 작으면 회절 구조의 바깥 근거리 영역이 가려져 설계된 근거리 성능이 나오지 않을 수 있습니다(동공 의존형 설계에서 특히). 소구경 IOL은 이미 작은 동공에 더 작은 조리개를 더하는 셈이라 광량이 부족해집니다.", act:"해당 렌즈의 동공 의존성을 확인하고, 동공 비의존 설계를 우선 고려하세요."},
  en:{t:"Photopic pupil < 2.5 mm", why:"A small pupil masks the outer near-addition zones, so the designed near performance may not be realised (especially in pupil-dependent designs). A small-aperture IOL adds a smaller stop to an already small pupil, starving the retina of light.", act:"Check the pupil dependence of the specific lens and favour pupil-independent designs."},
  refs:["R8","R18"], grade:"C", tests:[T.PUPIL]
},
{
  id:"astig_uncorrected", layer:"caution",
  targets:{trifocal:3, edofDiff:2.5, edofND:2, enhMono:1.5, smallAp:1, monoBlend:1},
...
},
{
  ...
  targets:{trifocal:1.5, edofDiff:1.2, edofND:0.8, smallAp:1},
...
},
{
  ...
  targets:{trifocal:1.5, edofDiff:1.2, edofND:1},
...
},
{
  ...
  targets:{trifocal:1, edofDiff:0.8, edofND:0.5, smallAp:1},
  when:d => !!d.ifis,
...
},
{
  ...
  targets:{trifocal:2, edofDiff:1.5, edofND:1, smallAp:1.5},
  when:d => d.zonule === "pxf",
...
},
{
  ...
  targets:{trifocal:2, edofDiff:1.5, edofND:0.8},
  when:d => !!d.vitrectomy,
...
},
{
  ...
  targets:{trifocal:1.5, edofDiff:1.2, edofND:0.8, monoBlend:2},
...
},
{
  ...
  targets:{trifocal:2.5, edofDiff:1.8, smallAp:2},
  when:d => d.nightDriving === 3 || d.nightWork === true,
  ko:{t:"야간 운전 · 야간 근무가 직업적으로 필수", why:"헤일로는 다초점에서 단초점 대비 약 3.6배 흔합니다(RR 3.58, 95% CI 1.99–6.46). 야간 시력이 생계와 직결되는 경우 이 위험은 취향의 문제가 아니라 안전의 문제입니다.", act:"야간 요구를 가장 앞에 두고 설계하세요. 비회절 설계 또는 단초점 + 근거리 안경 조합이 안전합니다."},
...
},
{
  ...
  targets:{trifocal:0.8, edofDiff:0.6},
